...
/// Maximum editor rows the composer may occupy. Grows from 1 up to this cap as
/// the draft gets taller; the *effective* limit is the dynamic live region,
/// which `term::resize_live_region` caps at ~50% of the terminal (ADR-0019
/// amendment 2026-07-22). This cap is just a sanity ceiling for huge pastes.
