...
- [ ] Background bash commands · AGENTS.md/CLAUDE.md session-start loading · custom
  slash-command files · subagents · plugins · config-file persistence (XDG).
...
(packaging, ADR-0011) · pack session-start file context (AGENTS.md/CLAUDE.md loading) · codex
