...
- Rejected: a minimal `locode-cli` gives a real end-to-end target and a reference consumer at near-zero cost; the full-featured binary still lives out-of-repo.
