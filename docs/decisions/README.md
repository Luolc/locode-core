...
| [0029](ADR-0029-session-picker.md) | Resuming without an id — a session picker behind `-r` (optional value) and `/resume`; directory scan over the reserved index; `/new`'s mid-run refusal reused | Accepted |
