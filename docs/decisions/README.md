...
| [0025](ADR-0025-agent-skills.md) | Agent Skills — shared discovery + whole-body-diffed `<system-reminder>` listing (rescanned post-run); body via a grok-pack `skill` tool (amends 0023, 0024) | Accepted |
